                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a href="#home" class="page-scroll active" aria-label="Toggle navigation"><?php echo translate('Halaman Utama'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#features" class="page-scroll" aria-label="Toggle navigation"><?php echo translate('Fitur - Fitur'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#pricing" class="page-scroll" aria-label="Toggle navigation"><?php echo translate('Tentukan Harga'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#faq" class="page-scroll" aria-label="Toggle navigation"><?php echo translate('FAQ'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#contact" class="page-scroll" aria-label="Toggle navigation"><?php echo translate('Kontak kami'); ?></a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3 pp-plans-container wow fadeInUp" data-wow-delay="<?php echo $delaycount ?>s">
                    <div class="pp-plans<?php echo $value->recommended == 1 ? ' pxp-is-featured' : '' ?>">
                        ...
                        <?php if ($value->recommended == 1) { ?>
                            <div class="pp-plans-featured-label">Rekomendasi</div>
                        <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-12">
                                ...
                                <div class="single-footer f-link">
                                    <h3>Link Cepat</h3>
                                    <ul>
                                        <li><a href="#home" class="page-scroll active" aria-label="Toggle navigation"><i class="fas fa-angle-right"></i> <?php echo translate('Halaman Utama'); ?></a></li>
                                        <li><a href="#features" class="page-scroll" aria-label="Toggle navigation"><i class="fas fa-angle-right"></i> <?php echo translate('Fitur'); ?></a></li>
                                        <li><a href="#pricing" class="page-scroll" aria-label="Toggle navigation"><i class="fas fa-angle-right"></i> <?php echo translate('Harga'); ?></a></li>
                                        <li><a href="#faq" class="page-scroll" aria-label="Toggle navigation"><i class="fas fa-angle-right"></i> <?php echo translate('FAQ'); ?></a></li>
                                        <li><a href="#contact" class="page-scroll" aria-label="Toggle navigation"><i class="fas fa-angle-right"></i> <?php echo translate('Kontak kami'); ?></a></li>
                                        <?php if ($getSettings->terms_status == 1) { ?>
                                        <a href="javascript:void(0)" id="termsFooter"><i class="fas fa-angle-right"></i> <?php echo translate('Syarat & Ketentuan'); ?></a>
                                        <?php } ?>
                                    </ul>
                                </div>
                                <!-- End Single Widget -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Langganan Kelas Sekolah</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="pp-plans-bottom">
                            <div class="pp-plans-cta button">
                                <button class="btn mb-4" data-id="1" type="submit" data-loading-text="<i class='fas fa-spinner fa-spin'></i> Processing">Daftar & Pembayaran</button>
                            </div>
                        </div>
                    </div>
                </div>
